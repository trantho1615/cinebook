...
**Interfaces:**
- Consumes: `booking.api.BookingView`, `booking.infra.BookingQueryJdbc` (Milestone 4); `identity.api.AccessControl`.
- Produces:
...
public class InitiatePaymentUseCase {
    ...
    public InitiatePaymentUseCase(NamedParameterJdbcTemplate jdbc, BookingQueryJdbc bookingQuery,
